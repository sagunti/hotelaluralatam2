...
CREATE TABLE `huespedes` (
  ...
  KEY `id_idx` (`idReserva`),
  CONSTRAINT `id` FOREIGN KEY (`idReserva`) REFERENCES `reservas` (`id`)
...
INSERT INTO `huespedes` VALUES (1,'Sam','Masia','1997-10-25','argentino-argentina','+5496555343',5),(2,'dhdhd','fgfgfgfg','1981-10-16','turco-turca','46748979797',6);
